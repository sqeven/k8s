...
# ship on docker
## you need already has [offline package](https://www.sqeven.com/) ( default is v1.11.3 > 1.10.3)
...
```
docker run --rm -v /data/kube1.11.3.tar.gz:/data/kube1.11.3.tar.gz -it -w /etc/ansible sqeven/k8s bash
```
